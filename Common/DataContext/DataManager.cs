...
namespace Common.DbContext
{
    public class MySqlConnection : AppConfiguration, System.IDisposable
    {
        ...
        public string DbConnection()
        {
            ...
            {
                throw new System.Exception(Utilities.ErrorCodes.ProcessException(ex, "", "", "", Utilities.ErrorCodes.MySqlExceptionMsg(ex)));
        ...
        public MySqlConnection()
        {
            ...
            {
                throw new System.Exception(Utilities.ErrorCodes.ProcessException(SqEx, "", "", "", Utilities.ErrorCodes.MySqlExceptionMsg(SqEx)));
            }
        }
    ...
    public class MySqlCommand : System.IDisposable
    {
        ...
        /// Function to insert datas to a particular table
        ...
        /// <param name="SPInitials"> If stored procedure's values is given with some initials, pass it here, default - null</param>
        /// </summary>
        public async Task AddOrEditWithStoredProcedure<T>(string SPName, List<T> ListData, T SingleRowData, string SPInitials="") where T : class 
        {
            Type temp = typeof(T);
